  ...
  return (
    <>
      ...
      <div className='container px-5 py-medium'>
        <Link to='/medication/add' className='inline-block px-4 py-2 mb-10 text-secondary border-2 border-secondary hover:text-white hover:bg-secondary font-semibold rounded-full text-base transition-colors'> Add Medication</Link>
                ...
                allMedications.map((medication, index) => {
                  return (
                    <tr key={medication._id}>
                      ...
                      <td className='p-4'>{medication.ehrVisit?.visitDate}</td>
                      <td className='p-4'>{medication.medicationName}</td>
                      <td className='p-4'>{medication.prescribedDate}</td>
